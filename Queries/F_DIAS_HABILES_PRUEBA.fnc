CREATE OR REPLACE FUNCTION "F_DIAS_HABILES_PRUEBA"
...
BEGIN
  ...
  --se ejecuta para los dias previstos en el job 20 y 25
  if v_dia_job = 20 or v_dia_job = 25 then
