...
namespace contingencia
{
    public class Util
    {
        ...
        #region EXCEL
        //public static void ExportToExcel(DataTable dt, string Archivo, string nombrehoja)
        //{
        ...
        public static string ExportarExcelDetalle(string RutaArchivo, DataTable Datos, string vTitulo)
        {
            try
            {
                ...
                //ws.Cell(Fila_3, Columna_A).Style.Font.SetBold(true);
                //ws.Cell(Fila_3, Columna_A).Style.Font.FontSize = 15;
